...
class VirtualMachine extends EventEmitter {
    ...
    deserializeProject(projectJSON, zip) {
        ...
        return deserializePromise().then(({ targets, extensions }) => this.installTargets(targets, extensions, true));
    }
    ...
    deleteSprite(targetId) {
        ...
        if (target) {
            ...
            const targetSpecificMonitorBlockIds = Object.keys(this.runtime.monitorBlocks._blocks).filter(
                key => this.runtime.monitorBlocks._blocks[key].targetId === targetId
            );
